...
import { BudgetItemPeriodComponent } from 'app/entities/budget-item-period/budget-item-period.component';
...
describe('Component Tests', () => {
    describe('BudgetItemPeriod Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.budgetItemPeriods[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
