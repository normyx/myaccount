    ...
    describe('BudgetItemPeriod Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/budget-item-periods';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a BudgetItemPeriod', () => {
                service.create(new BudgetItemPeriod(null)).subscribe(received => {
            ...
            it('should update a BudgetItemPeriod', () => {
                service.update(new BudgetItemPeriod(123)).subscribe(received => {
            ...
            it('should return a BudgetItemPeriod', () => {
            ...
            it('should return a list of BudgetItemPeriod', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new BudgetItemPeriod(123)]);
            });
