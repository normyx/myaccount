    ...
    describe('BudgetItem Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/budget-items';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a BudgetItem', () => {
                service.create(new BudgetItem(null)).subscribe(received => {
            ...
            it('should update a BudgetItem', () => {
                service.update(new BudgetItem(123)).subscribe(received => {
