    ...
    describe('SubCategory Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/sub-categories';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a SubCategory', () => {
                service.create(new SubCategory(null)).subscribe(received => {
            ...
            it('should update a SubCategory', () => {
                service.update(new SubCategory(123)).subscribe(received => {
            ...
            it('should return a SubCategory', () => {
