CREATE PROCEDURE get_report_amounts_where_accountId_category_grp_by_month (IN inAccountId bigint(20), IN inCategoryId bigint(20), IN inFromMonth DATE, IN inToMonth DATE)
BEGIN
SELECT 
    ...
    opr.amount_avg_12 AS amount_avg_12
FROM
    (SELECT 
...
WHERE br.account_id = inAccountId AND br.category_id = inCategoryId AND br.month >= inFromMonth AND br.month <= inToMonth;
END;